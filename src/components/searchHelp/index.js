...
import searchSubmit from '../../config/searchConfig';
import SearchHelpContainer from './styled';

export default function SearchHelp(props) {
  const { namePlaceholder, help, marginBottom } = props;

  return (
    <SearchHelpContainer marginBottom={marginBottom}>
      <form onSubmit={searchSubmit} action="/vertical/search">
        <button type="submit">
          <svg
        ...
        <input type="text" placeholder={namePlaceholder} name="search_query" />
      </form>
      {help && (
